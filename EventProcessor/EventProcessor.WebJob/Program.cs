...
namespace Microsoft.Azure.Devices.Applications.RemoteMonitoring.EventProcessor.WebJob
{
    ...
    public static class Program
    {
        ...
        static void StartFeedbackProcessorHost()
        {
            Trace.TraceInformation("Starting Feedback Processor");
            var feedbackProcessor = eventProcessorContainer.Resolve<IFeedbackEventProcessor>();
