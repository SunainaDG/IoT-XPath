...
namespace Microsoft.Azure.Devices.Applications.RemoteMonitoring.EventProcessor.WebJob
{
    public sealed class EventProcessorModule : Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<FeedbackEventProcessor>().As<IFeedbackEventProcessor>().SingleInstance();
            ...
            builder.RegisterType<LocationJerkLogic>().As<ILocationJerkLogic>();
            builder.RegisterType<LocationJerkRepository>().As<ILocationJerkRepository>();
            builder.RegisterType<LocationRulesLogic>().As<ILocationRulesLogic>();
            builder.RegisterType<LocationRulesRepository>().As<ILocationRulesRepository>();
        }
    }
}
