IoTApp.createModule('IoTApp.LocationRulesIndex', function () {
    "use strict";
    ...
    var _selectRowFromDataTable = function (row) {
        ...
        if (rowData != null) {
            ...
            self.selectedRegionId = rowData["regionId"];
            self.ruleProperties.init(rowData["regionId"], rowData["ruleId"], self.reloadGrid);
        }
    }
    ...
    var _initializeDatatable = function () {
        ...
        self.dataTable = self.dataTableContainer.DataTable({
            ...
            "processing": false,
            "serverSide": false,
            "dom": "<'dataTables_header'i<'rules_list_button_area'>>lrtp?",
            ...
            "columns": [
                ...
                },
                {
                    "data": "region",
                    "mRender": function (data) {
                        var readableData = data.replace("#", ",");
                        return htmlEncode(readableData);
                    },
                    "name": "region"
                },
                {
                ...
                {
                    "data": "lateralThreshold",
                    "mRender": function (data) {
                        return IoTApp.Helpers.Numbers.formatCoordinates(data);
                    },
                    "name": "lateralThreshold"
                },
                {
    ...
    var onDataTableAjaxCalled = function (data, fnCallback) {
        ...
        var successCallback = function (json, a, b) {
            if (self.selectedRuleId && self.selectedRegionId) {
                ...
                for (var i = 0, len = json.data.length; i < len; ++i) {
                    ...
                    if (data &&
                        data.ruleId === self.selectedRuleId && data.regionId === self.selectedRegionId) {
    ...
    // close the rule details pane (called when rule is no longer shown)
    ...
    var _initializeButtonArea = function () {
        var $buttonArea = $('.rules_list_button_area');
        ...
        $('<button/>', {
            ...
            text: 'Default Rule',
            click: function () {
                location.href = resources.defaultRuleUrl;
            }
        }).appendTo($buttonArea);
    }
...
$(function () {
    ...
    IoTApp.LocationRulesIndex.init(IoTApp.LocationRuleProperties);
});