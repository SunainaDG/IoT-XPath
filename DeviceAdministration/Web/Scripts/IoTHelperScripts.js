...
IoTApp.createModule("IoTApp.Helpers.Numbers", function () {
    ...
    var formatCoordinates = function formatCoordinates(number) {
        var coord = Globalize.format(number, "N" + (number.toString().length - number.toString().indexOf('.') - 1).toString(), cultureInfo);
